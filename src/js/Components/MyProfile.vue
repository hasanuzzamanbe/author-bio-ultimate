<template>
	<div class="main-profile-container">
		...
		<div class="inner_box">
			<el-row class="users_details_row">
				<el-col :sm="22" :lg="12">
					<span class="users_name_label"
						><strong>{{ $t('Full Name*') }}</strong></span
					>
					<el-input
			...
			<el-row class="users_details_row">
				<el-col :sm="22" :lg="12">
					<span class="users_name_label"
						><strong>{{ $t('Email Address*') }}</strong></span
					>
					<el-input
			...
			<el-row class="users_details_row">
				<el-col :sm="22" :lg="12">
					<span class="users_designation_label"
						><strong>{{ $t('Designation') }}</strong></span
					>
					<el-input
		...
		<h3 class="users_details_row_header">
			Author Bio Details:
			<el-tooltip class="item" placement="bottom-start" effect="light">
				<div slot="content">
					<p>
						...
						<br />
						updated on your user profile page. Or Add new bio using
						editor.
					</p>
				</div>
		...
		<div class="inner_box">
			<el-row>
				<el-col :span="12">
					<el-radio
						default
						v-model="authorDetails.useBioFrom"
						label="userProfileBio"
						>Use bio from user profile
					</el-radio>
					<el-radio
						v-model="authorDetails.useBioFrom"
						label="newAddedBio"
						>Update your bio with Editor
					</el-radio>
				</el-col>
			</el-row>
			<el-row
				v-if="authorDetails.useBioFrom === 'newAddedBio'"
				class="users_details_row"
				:rules="rules"
			>
				<el-col :sm="22" :lg="12">
					<span class="users_bio_label"
						><strong>Your Bio Data Here</strong></span
					>
		...
		<h3 class="users_details_row_header">
			...
			<el-tooltip class="item" placement="bottom-start" effect="light">
				<div slot="content">
					<p>
						Select socials to show frontent, and put your profile
						link.
					</p>
				</div>
				<i style="float: right;" class="el-icon-info el-text-info" />
		...
		<div class="inner_box">
			<el-row class="users_details_row">
				<el-col :sm="22" :lg="12">
					<el-checkbox
						v-model="isShow.facebook"
						true-label="true"
						label="Facebook"
					></el-checkbox>
					<el-checkbox
						v-model="isShow.twitter"
						true-label="true"
						label="Twitter"
					></el-checkbox>
					<el-checkbox
						v-model="isShow.linkedin"
						true-label="true"
						label="Linkedin"
					></el-checkbox>
					<el-checkbox
						v-model="isShow.instagram"
						true-label="true"
						label="Instagram"
					></el-checkbox>
				</el-col>
			...
			<el-row class="users_details_row" v-if="isShow.instagram">
				<el-col :sm="22" :lg="12">
					<span class="users_name_label"
						><strong>{{ $t('Instagram') }}</strong></span
					>
					<el-input
		...
		<h3 class="users_details_row_header">
			...
			<el-tooltip class="item" placement="bottom-start" effect="light">
				<div slot="content">
					<p>
						use gravatar image: will show your profile image from
						gravatar.<br />
		...
		<div class="inner_box">
			<el-row>
				<el-col :span="12">
					<el-radio v-model="imageFrom" label="gravatar">{{
						$t('Use Gravatar image')
					}}</el-radio>
					<el-radio v-model="imageFrom" label="upload">{{
						$t('Upload image')
					}}</el-radio>
				</el-col>
			</el-row>
			...
			<el-row class="users_details_row">
				...
				<el-col :span="8" v-if="imageFrom === 'gravatar'">
					...
					<br />
					<p>
						NB: Be sure, your email address has gravatar. also You
						can change your profile picture on
			...
			return {
				rules: {
					email_body: [
						{
							required: true,
							message: 'Please Provide Notification Title'
						}
					]
				},
					...
					if (res.data.data) {
						...
						(this.authorDetails.authorId = res.data.data.author_id),
							(this.authorDetails.name =
								res.data.data.author_name),
							(this.authorDetails.email =
								res.data.data.author_email),
							(this.authorDetails.designation =
								res.data.data.author_designation),
							(this.authorDetails.bio = res.data.bio),
							(this.authorDetails.facebook =
								res.data.data.author_fb),
							(this.authorDetails.twitter =
								res.data.data.author_tw),
							(this.authorDetails.linkedin =
								res.data.data.author_ln),
							(this.authorDetails.instagram =
								res.data.data.author_ins),
							(this.authorDetails.useBioFrom =
								res.data.data.useBioFrom),
